...
class EGStopWatchViewController: EGBasicViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        resetButton.frame = CGRect.init(x:0, y: SCREEN_HEIGHT * 0.5, width: SCREEN_WIDTH * 0.5, height: SCREEN_HEIGHT * 0.5)
        
        playButton.frame = CGRect.init(x:SCREEN_WIDTH * 0.5, y: SCREEN_HEIGHT * 0.5, width: SCREEN_WIDTH * 0.5, height: SCREEN_HEIGHT * 0.5)
    }
